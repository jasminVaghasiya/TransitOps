  ...
  modalBody.innerHTML = `
    <form id="create-vehicle-form">
      ...
      <div class="input-group">
        ...
        <label for="veh-type"><i class="fa-solid fa-truck-moving"></i> Vehicle Type</label>
      </div>
      <div class="input-group">
        <select id="veh-region" required>
          <option value="North">North</option>
          <option value="South">South</option>
          <option value="East">East</option>
          <option value="West">West</option>
        </select>
        <label for="veh-region"><i class="fa-solid fa-map-location-dot"></i> Region</label>
      </div>
