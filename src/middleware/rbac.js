...
const ROLE_ABILITIES = {
  ...
  [ROLES.FLEET_MANAGER]: {
    [ACTIONS.READ]: [SUBJECTS.VEHICLE, SUBJECTS.MAINTENANCE, SUBJECTS.DRIVER, SUBJECTS.TRIP, SUBJECTS.FUEL_LOG, SUBJECTS.EXPENSE, SUBJECTS.REPORT, SUBJECTS.DASHBOARD],
    [ACTIONS.CREATE]: [SUBJECTS.VEHICLE, SUBJECTS.MAINTENANCE],
    [ACTIONS.UPDATE]: [SUBJECTS.VEHICLE, SUBJECTS.MAINTENANCE],
    [ACTIONS.DELETE]: [SUBJECTS.VEHICLE, SUBJECTS.MAINTENANCE],
    [ACTIONS.RETIRE]: [SUBJECTS.VEHICLE],
    [ACTIONS.ASSIGN]: [SUBJECTS.VEHICLE],
    [ACTIONS.CLOSE]: [SUBJECTS.MAINTENANCE],
  ...
  [ROLES.DISPATCHER]: {
    ...
    [ACTIONS.CREATE]: [SUBJECTS.TRIP],
    [ACTIONS.UPDATE]: [SUBJECTS.TRIP],
    [ACTIONS.DELETE]: [SUBJECTS.TRIP],
