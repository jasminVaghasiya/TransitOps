...
const ROLE_ABILITIES = {
  [ROLES.FLEET_MANAGER]: {
    ...
    [ACTIONS.CREATE]: [SUBJECTS.VEHICLE, SUBJECTS.TRIP, SUBJECTS.EXPENSE, SUBJECTS.FUEL_LOG, SUBJECTS.MAINTENANCE, SUBJECTS.DRIVER],
    [ACTIONS.UPDATE]: [SUBJECTS.VEHICLE, SUBJECTS.TRIP, SUBJECTS.EXPENSE, SUBJECTS.FUEL_LOG, SUBJECTS.MAINTENANCE, SUBJECTS.DRIVER],
    [ACTIONS.DELETE]: [SUBJECTS.VEHICLE, SUBJECTS.TRIP, SUBJECTS.EXPENSE, SUBJECTS.FUEL_LOG, SUBJECTS.MAINTENANCE, SUBJECTS.DRIVER],
  },
  [ROLES.DRIVER]: {
